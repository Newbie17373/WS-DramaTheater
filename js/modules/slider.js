...
<div class="slider__tape">
    <div class="slider__tape-item"><img src="./img/main/uncle_liova.webp" alt="" class="slider__img">
        <a href="#">
    ...
    <div class="slider__tape-item"><img src="./img/main/tanya.webp" alt="" class="slider__img">
        <a href="#">
            <div class="slider__tape-shadow">
                <p class="slider__text">/ премьера</p>
    ...
    <div class="slider__tape-item"><img src="./img/main/vishnevyi_sad.webp" alt="" class="slider__img">
        <a href="#">
        <div class="slider__tape-shadow">
                <p class="slider__text">/ премьера</p>
